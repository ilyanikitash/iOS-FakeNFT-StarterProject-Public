...
## Модуль 1:
 #### Profile Screen
- Протокол ProfileViewModel (est: 2.30 часа; fact: x часов)
- Модель Profile (est: 40 мин; fact: x часов)
- ProfileCardView (AvatarImageView + UserNameLabel + DescriptionLabel) (est: 1.30 часа; fact: x часов)
- ProfileServiceImpl (mock data) (est: 2 часа; fact: x часов)
- ProfilerService (protocol) (est: 3 часа; fact: x часов)
...
- Observabl<T> (обертка для биндинга данных) (est: 20 мин; fact: x часов)
- Биндинг данных (est: 40 мин; fact: x часов)
- ProfileRequest (est: 50 мин; fact: x часов)
- WebViewViewController (переход с ячейки "О разработчике" + переход по линку на сайт пользователя) (est: 3 часа; fact: x часов)
- ProfileServiceImpl (данные с бэка) (est: 1.30 час; fact: x часов)
